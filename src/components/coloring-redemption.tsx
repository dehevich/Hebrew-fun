...
import { Star, Download, Lock, CheckCircle, Palette } from 'lucide-react';
...
export function ColoringRedemption({ points, onRedeem, onDownload, redeemedSheets }: ColoringRedemptionProps) {
      ...
      <Card className="bg-gradient-to-r from-purple-500 to-pink-500 text-white border-0">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold flex items-center justify-center gap-2">
            ...
            Coloring Sheets Store 🎨
          </CardTitle>
          <p className="text-lg opacity-90">Use your points to unlock fun coloring pages!</p>
        </CardHeader>
        <CardContent className="text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            <Star className="w-6 h-6 text-yellow-300" />
            <span className="text-2xl font-bold">{points} Points Available</span>
          </div>
