        ...
        return (
          <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 p-4 safe-area-inset">
            ...
            <Card className="mb-6 p-4 text-center">
              ...
              <div className="text-5xl mb-3">{currentWordBuilderWord.emoji}</div>
        ...
        return (
          <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 p-4 safe-area-inset">
            ...
            <div className="space-y-4">
              <Card className="p-4">
                <div className="flex flex-wrap justify-center gap-2" dir="rtl"> {/* Added dir="rtl" */}
                  {puzzlePieces.map((piece, index) => (
                    ...
                    >
                      {piece.hebrew}
                      <span className="text-xs text-gray-500">{piece.english}</span> {/* Added English name */}
                    </HapticButton>
                  ))}
                </div>
              </Card>
      ...
      case 'shape-recognition':
        ...
        return (
          <ShapeRecognitionGame
            ...
            points={currentProfile.points} // Pass points to ShapeRecognitionGame
